  ...
  return (
    <div className="min-h-[60vh] flex items-center justify-center px-4">
      <div className="max-w-xl w-full text-center glass-pane rounded-2xl border p-8">
        ...
        <h1 className="text-2xl font-bold mb-2">Industry page not available</h1>
        <p className="text-sm text-muted-foreground mb-6">
          The industry page you requested is disabled or doesn’t exist. Explore available industries or return
          to the main site.
        </p>
