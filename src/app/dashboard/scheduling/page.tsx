...
//   const { data: shiftData, loading: shiftLoading, refetch: refetchShifts } = useShifts(startISO, endISO);
...
//   const canManageScheduling = permissions.canManageScheduling?.() ?? true;
