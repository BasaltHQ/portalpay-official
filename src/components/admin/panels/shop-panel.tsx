...
export function ShopPanel() {
  ...
  // Intentionally removed document.title override so Admin shell controls it
  useEffect(() => {
    if (!loading && cfg.name && cfg.theme.brandLogoUrl) {
      // Just update favicon to shop logo if available
