...
//   query: string,
//   limit = 8,
//   options?: QueryHookOptions<any, { query: string; limit: number }>
// ) =>
...
//   useQuery(GET_TEAM_PERFORMANCE, { variables });
...
//   useQuery(GET_INVENTORY_ITEMS, { variables });
// export const useInventorySummary = () => useQuery(GET_INVENTORY_SUMMARY);
// export const useInventoryAlerts = () => useQuery(GET_INVENTORY_ALERTS);
...
//   useQuery(GET_WASTE_REPORT, { variables });
...
// export const useSuppliers = () => useQuery(GET_SUPPLIERS);
// export const useSupplierPerformance = (variables?: { startDate?: string; endDate?: string }) =>
//   useQuery(GET_SUPPLIER_PERFORMANCE, { variables });
// export const usePurchaseOrders = (variables?: { status?: string }) => useQuery(GET_PURCHASE_ORDERS, { variables });
...
//   useQuery(GET_SERVICE_PACKAGES, { variables });
// export const useServicePackage = (id?: string) =>
//   useQuery(GET_SERVICE_PACKAGE, { variables: id ? { id } : undefined, skip: !id });
// export const useCreateServicePackage = () => useMutation(CREATE_SERVICE_PACKAGE, { refetchQueries: ["GetServicePackages"] });
...
//   useQuery(GET_SERVICE_BAYS, { variables });
// export const useServiceLaneTickets = (variables?: { status?: string }) =>
//   useQuery(GET_SERVICE_LANE_TICKETS, { variables });
...
// export const useAutomationAssets = () => useQuery(GET_AUTOMATION_ASSETS);
...
//   useQuery(GET_SHOP_ANALYTICS, { variables });
...
//   useQuery(GET_INVOICES, { variables });
// export const useInvoice = (id?: string) =>
//   useQuery(GET_INVOICE, { variables: id ? { id } : undefined, skip: !id });
// export const useCreateInvoice = () => useMutation(CREATE_INVOICE, { refetchQueries: ["GetInvoices"] });
